...
bool processVictims(const cv::Mat& img_in, cv::Mat &showImage, const double scale, std::vector<std::pair<int,Polygon>>& victim_list, const std::string& config_folder, bool arena);
